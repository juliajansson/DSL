...
/* package DSLsofMath-0.1.9.1 */
#define VERSION_DSLsofMath "0.1.9.1"
#define MIN_VERSION_DSLsofMath(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "DSLsofMath-0.1.9.1-ErgwwIOcSLrKzbjYQkUI9G"

#define CURRENT_PACKAGE_KEY "DSLsofMath-0.1.9.1-ErgwwIOcSLrKzbjYQkUI9G"
